...
const chinelos = [
  {
    ...
    description:
      "O clássico chinelo brasileiro, confortável e durável para o dia a dia.",
    base_price: 25.9,
  ...
  },
  {
    ...
    sku: "HAV-BRASIL-008",
    photo:
      "https://images.unsplash.com/photo-1472887743288-0150ba830cab?w=400&h=400&fit=crop",
  },
  {
    name: "Chinelo Ipanema Anatomic",
    description: "Design anatômico que se adapta perfeitamente aos pés.",
    base_price: 33.9,
    suggested_price: 43.0,
  ...
  },
  {
    ...
    base_price: 24.9,
    suggested_price: 34.0,
    sku: "IPA-WAVE-014",
    photo:
      "https://images.unsplash.com/photo-1594736797933-d0c8bb0e9802?w=400&h=400&fit=crop",
  },
  {
    ...
    sku: "RID-STRIKE-015",
    photo:
      "https://images.unsplash.com/photo-1518002171953-a080ee817e1f?w=400&h=400&fit=crop",
  },
  {
    ...
    sku: "HAV-KIDS-016",
    photo:
      "https://images.unsplash.com/photo-1574708532532-37f6b985b7e8?w=400&h=400&fit=crop",
  },
  {
  ...
  },
  {
    ...
    photo:
      "https://images.unsplash.com/photo-1506629905607-c9d320ac4e33?w=400&h=400&fit=crop",
  },
  {
    name: "Chinelo Billabong All Day",
    description: "Conforto para usar o dia todo.",
    base_price: 44.9,
    suggested_price: 58.0,
    sku: "BILL-ALLDAY-019",
    photo:
  ...
  },
  {
    ...
    base_price: 78.9,
    suggested_price: 98.0,
    sku: "OSK-IPA-020",
    photo:
      "https://images.unsplash.com/photo-1552066344-2464c1135c32?w=400&h=400&fit=crop",
  },
  {
    name: "Chinelo Havaianas Metallic",
    description: "Acabamento metalizado para um visual sofisticado.",
    base_price: 39.9,
    suggested_price: 52.0,
  ...
  },
  {
    ...
    base_price: 46.9,
    suggested_price: 59.0,
    sku: "KEN-KICKS-024",
    photo:
      "https://images.unsplash.com/photo-1580906853819-04bc41c0c10c?w=400&h=400&fit=crop",
  },
  {
  ...
  },
  {
    ...
    sku: "LAC-CROCO-029",
    photo:
      "https://images.unsplash.com/photo-1449247709967-d4461a6a6103?w=400&h=400&fit=crop",
  },
  {
...
export async function seedChinelos() {
  try {
    ...
    const [categories] = await db.execute(
      "SELECT id FROM categories WHERE name LIKE '%chinelo%' OR name LIKE '%sandália%' LIMIT 1",
    );
    ...
    for (let i = 0; i < chinelos.length; i++) {
      ...
      for (const cor of cores) {
        for (const tamanho of tamanhos) {
          ...
          const priceOverride =
            Math.random() > 0.8
              ? produto.base_price * (1 + (Math.random() * 0.3 - 0.15))
              : null;
      ...
      const shuffledGrades = [...grades]
        .sort(() => 0.5 - Math.random())
        .slice(0, numGrades);
      const shuffledColors = [...cores]
        .sort(() => 0.5 - Math.random())
        .slice(0, numColors);
    ...
    console.log(
      `   • ${chinelos.length * cores.length * tamanhos.length} variantes criadas`,
    );
