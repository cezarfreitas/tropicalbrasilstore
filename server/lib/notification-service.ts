...
export async function sendEmailNotification(
  ...
  try {
    ...
    // Get email template
    const emailSubject =
      (await getNotificationSetting("email_subject")) || "Novo Pedido";
    const emailTemplate =
      (await getNotificationSetting("email_template")) || "";
...
export async function sendWebhookNotification(
  ...
  try {
    ...
    const webhookMethod =
      (await getNotificationSetting("webhook_method")) || "POST";
    const webhookHeaders =
      (await getNotificationSetting("webhook_headers")) || "{}";
    const webhookTemplate =
      (await getNotificationSetting("webhook_template")) || "{}";
