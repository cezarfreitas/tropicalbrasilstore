...
export default function ProductImport() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Sistema Exclusivo de Grades */}
      <Card className="border-blue-200 bg-blue-50/50">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-blue-800">
            <Grid3X3 className="h-5 w-5" />
            🆕 Sistema Exclusivo para Importação de Grades
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <p className="text-blue-700">
              Agora temos um sistema dedicado especificamente para produtos vendidos por grade completa!
            </p>
            <div className="flex gap-4">
              <Button asChild className="bg-blue-600 hover:bg-blue-700">
                <a href="/admin/products/grade-import">
                  <Grid3X3 className="h-4 w-4 mr-2" />
                  Acessar Sistema de Grades
                </a>
              </Button>
            ...
            <div className="text-sm text-blue-600 bg-white p-3 rounded-lg border border-blue-200">
              <strong>✨ Vantagens do sistema de grades:</strong>
              <ul className="list-disc list-inside mt-2 space-y-1">
                <li>Template simplificado com apenas campos essenciais</li>
                <li>Processo otimizado para produtos vendidos por grade</li>
                <li>Interface dedicada e mais intuitiva</li>
