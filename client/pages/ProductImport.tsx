...
export default function ProductImport() {
  ...
  const autoMapColumn = (headers: string[], targetField: string): string => {
    const commonMappings: Record<string, string[]> = {
      ...
      color_sale_price: ["preco_promocional_cor", "color_sale_price"],
      color_image_url: ["imagem_cor", "color_image", "foto_variante"],
      sell_without_stock: ["vender_sem_estoque", "sell_without_stock"],
      size_37: ["tam_37", "size_37", "37", "tamanho_37"],
      size_38: ["tam_38", "size_38", "38", "tamanho_38"],
      size_39: ["tam_39", "size_39", "39", "tamanho_39"],
      size_40: ["tam_40", "size_40", "40", "tamanho_40"],
      size_41: ["tam_41", "size_41", "41", "tamanho_41"],
      size_42: ["tam_42", "size_42", "42", "tamanho_42"],
      size_43: ["tam_43", "size_43", "43", "tamanho_43"],
      size_44: ["tam_44", "size_44", "44", "tamanho_44"],
