...
export default function Notifications() {
  const [settings, setSettings] = useState<NotificationSettings>({
    ...
    smtp_password: "",
    smtp_from_email: "",
    smtp_from_name: "Tropical Brasil Sandálias",
    email_subject: "🎉 Novo Pedido Recebido - Tropical Brasil Sandálias",
    email_template: "",
  ...
  const saveSettings = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Deploy Necessário",
          description:
            "As rotas de notificação serão ativadas no próximo deploy.",
          variant: "default",
        });
      } else {
        toast({
