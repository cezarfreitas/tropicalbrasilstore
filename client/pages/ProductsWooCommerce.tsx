...
import { getImageUrl, getMainProductImage } from "@/lib/image-utils";
...
export default function ProductsWooCommerce() {
  ...
  const [formData, setFormData] = useState<
    WooCommerceProduct & { stock_type?: "size" | "grade" }
  >({
    name: "",
    description: "",
  ...
  const reorderVariantImages = (
    ...
    if (
      variant.images &&
      variant.images.length > Math.max(fromIndex, toIndex)
    ) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const cleanedFormData = {
          ...
          color_variants: (fullProduct.color_variants || []).map(
            (variant: ColorVariant) => ({
              ...variant,
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          min="0"
                          value={
                            formData.suggested_price != null
                              ? formData.suggested_price.toString()
                              : ""
                          }
                          onChange={(e) =>
                            setFormData({
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        >
                          ...
                          <p className="text-sm text-muted-foreground">
                            Cada grade tem uma quantidade específica (ex: 25
                            pares) independente dos tamanhos
                          </p>
                        </div>
                        <div
                          className={`p-4 border rounded-lg cursor-pointer transition-all ${
                        ...
                        >
                          ...
                          <p className="text-sm text-muted-foreground">
                            Cada tamanho/cor tem estoque individual (ex: 5 pares
                            tam 38 azul, 3 pares tam 39 azul)
                          </p>
                        </div>
                      </div>
                    </div>
                                  ...
                                  <div className="space-y-4">
                                    <div>
                                      ...
                                      <p className="text-xs text-muted-foreground mb-3">
                                        A primeira imagem será usada como
                                        principal
                                      </p>
                                  ...
                                  {(formData as any).stock_type === "grade" ? (
                                      ...
                                      variant.grade_ids.length === 0 ? (
                                        ...
                                        <div className="space-y-3">
                                          ...
                                          <div className="text-xs text-blue-600 italic p-2 bg-blue-50 rounded">
                                            💡 Cada grade tem uma quantidade
                                            total (ex: 25 pares) independente
                                            dos tamanhos
                                          </div>
                                        </div>
                                      )}
                                    ...
                                    <div>
                                      ...
                                      <div className="text-xs text-green-600 italic p-2 bg-green-50 rounded mt-3">
                                        💡 Cada tamanho/cor tem estoque
                                        individual (ex: 5 tam 38, 3 tam 39)
                                      </div>
                                    </div>
                                  )}
                                </CardContent>
