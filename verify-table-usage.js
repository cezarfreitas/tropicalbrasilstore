...
async function verifyTableUsage() {
  ...
  try {
    ...
    const lowDataTables = tableStats.filter(stat => stat.count > 0 && stat.count < 5);
    ...
    if (unusedTables.length > 0) {
      ...
      console.log("Algumas tabelas podem ser usadas dinamicamente ou em queries construídas em runtime.");
    } else {
